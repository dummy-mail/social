                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            <div className="my-3">
                                ...
                                <select name="category" onChange={catForm.handleChange} className={'form-control '+(catForm.errors.category && catForm.touched.category ? 'is-invalid' : '')} > 
                            ...
                            <div className="my-3">
                                ...
                                <div className="input-group">
                                    <input type="text" name="subcategory" onChange={catForm.handleChange}  placeholder="Enter Name of Category" aria-describedby="basic" className={'form-control '+(catForm.errors.subcategory && catForm.touched.subcategory ? 'is-invalid' : '')} />
